...
router.get('/organizer/challenges', requireOrganizerAuth, async (req, res) => {
  try {
    const challenges = await getAllChallenges();
...
router.get('/organizer/participants', requireOrganizerAuth, async (req, res) => {
  try {
    const participants = await getParticipantsWithProgress();
...
router.get('/organizer/submissions', requireOrganizerAuth, async (req, res) => {
  try {
...
router.get('/organizer/hints', requireOrganizerAuth, async (req, res) => {
  try {
